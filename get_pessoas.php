		...
		while ( $registro = mysqli_fetch_array($resultado_id, MYSQLI_ASSOC)){
			echo '<a href="#" class="list-group-item">';
				...
				echo '<p class="list-group-item-text pull-right">';
					...
					echo '<button type="button" id="btn_seguir_'.$registro['id'].'" class="btn btn-default btn-seguir" style="display: '.$btn_seguir_display.'" data-id_usuario="'.$registro['id'].'">Seguir</button>';
					
					echo '<button type="button" id="btn_deixar_seguir_'.$registro['id'].'" class="btn btn-primary btn-deixar-seguir" style="display: '.$btn_deixar_seguir_display.'" data-id_usuario="'.$registro['id'].'">Deixar de Seguir</button>';
